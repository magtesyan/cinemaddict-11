...
render(siteMain, new FilmsComponent(filmCards).getElement(), RenderPosition.BEFOREEND);
...
render(siteFooterStatiscticsSection, new FooterStatsComponent(filmCards).getElement(), RenderPosition.BEFOREEND);
